...
%   conozan separando o nombre da variable entre comillas do valor da
%   misma mediante unha coma ',' e as distintas variables separadas
%   mediante un punto e coma ';' tal e como se mostra no ejemplo
%   Deixar as variables que son incógnitas igualadas a 0
%   (O espaciado que se deixe non influye na ejecución do programa

Variables = ["Variable 1",1.0024;"Variable 2",2;"holis",0;"kk",0];
